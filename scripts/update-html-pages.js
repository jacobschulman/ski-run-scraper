...
// Generate updated snow.html template - uses new widget card design
function generateSnowHtml() {
  return fs.readFileSync(path.join(DATA_DIR, 'vail/snow.html'), 'utf8');
}

// Generate updated lifts.html template - uses new widget card design
function generateLiftsHtml() {
  return fs.readFileSync(path.join(DATA_DIR, 'vail/lifts.html'), 'utf8');
}
