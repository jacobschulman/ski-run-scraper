...
// ═══════════════════════════════════════════════════════════════════════════════
// CUSTOM API FUNCTIONS (ReportPal, Zaneray, DOR)
// ═══════════════════════════════════════════════════════════════════════════════

/**
 * Fetch lift data from ReportPal API (Big Sky, Sugarloaf, Sunday River, Loon, Cypress)
 */
...
/**
 * Run ReportPal scraper (Big Sky, Sugarloaf, Sunday River, Loon, Cypress Mountain)
 */
...
/**
 * Run Zaneray scraper (Jackson Hole)
 */
...
/**
 * Run DOR scraper (Snowbird, Copper, Killington)
 */
...
async function main() {
  ...
  console.log(`API scrapers: Inspector, Aspen, ReportPal, Zaneray, DOR`);
  ...
  while (!isShuttingDown) {
    ...
    // Check if it's time for Ikon + custom API scrapers (every 2 min)
    if (now - lastIkonRun >= CONFIG.ikon.intervalMs) {
      ...
      runReportPalScraper().catch(console.error);  // Big Sky, Sugarloaf, Sunday River, Loon, Cypress
      runZanerayScraper().catch(console.error);    // Jackson Hole
      runDorScraper().catch(console.error);        // Snowbird, Copper, Killington
    }
